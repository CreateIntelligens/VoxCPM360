...
_REFERENCE_AUDIO_PRESETS: tuple[dict[str, str], ...] = (
    ...
    {
        "id": "cosy-young-female-02",
        "label": "青年女聲 02（Hayley・臺灣台語）",
        "filename": "cosy-young-female-02.mp3",
        "description": "青年女聲",
        "prompt_text": "你好，歡迎使用創造智能台語生成服務，很高興為你服務，請輸入想要生成的文本內容",
        "gender": "female",
        "language": "nan-TW",
    },
    {
...
_CASTVOICE_DEFINITIONS: tuple[dict[str, Any], ...] = (
    ...
    {
        "voice_id": "voxcpm2-cosy-young-female-02",
        "label": "青年女聲 02（Hayley・臺灣台語）",
        "gender": "female",
        "language": "nan-TW",
        "desc": "青年女聲，VoxCPM2 zero-shot 聲音克隆",
        "engine_id": "voxcpm2",
        "reference_preset_id": "cosy-young-female-02",
    },
    {
